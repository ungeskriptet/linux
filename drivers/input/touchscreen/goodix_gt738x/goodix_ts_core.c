...
//@reset_delay_time reset_delay_time flag;  -0730
int reset_delay_time =0;
/**
...
{
	int i;
//ts_err("pen report coords.status %d.\n",pen_data->coords.status);
...
//	__set_bit(BTN_LEFT, pen_dev->keybit);
	...
	input_set_abs_params(pen_dev, ABS_TILT_X, -1*GOODIX_PEN_MAX_TILT, GOODIX_PEN_MAX_TILT, 0, 0);
	input_set_abs_params(pen_dev, ABS_TILT_Y, -1*GOODIX_PEN_MAX_TILT, GOODIX_PEN_MAX_TILT, 0, 0);
