...
static struct clk_hw *sm7150_rpmh_clocks[] = {
	[RPMH_CXO_CLK]		= &sdm845_bi_tcxo.hw,
	[RPMH_CXO_CLK_A]	= &sdm845_bi_tcxo_ao.hw,
	[RPMH_LN_BB_CLK2]	= &sdm845_ln_bb_clk2.hw,
	[RPMH_LN_BB_CLK2_A]	= &sdm845_ln_bb_clk2_ao.hw,
...
static const struct clk_rpmh_desc clk_rpmh_sm7150 = {
	.clks = sm7150_rpmh_clocks,
	.num_clks = ARRAY_SIZE(sm7150_rpmh_clocks),
};
...
static const struct of_device_id clk_rpmh_match_table[] = {
	...
	{ .compatible = "qcom,sm7150-rpmh-clk", .data = &clk_rpmh_sm7150},
