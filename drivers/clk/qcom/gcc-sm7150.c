...
#include <dt-bindings/clock/qcom,gcc-sm7150.h>
...
//static const struct qcom_cc_dfs_desc gcc_sm7150_dfs_desc = {
//	.clks = gcc_dfs_clocks,
...
static const struct qcom_cc_desc gcc_sm7150_desc = {
	...
	//.hwclks = gcc_sm7150_hws,
	//.num_hwclks = ARRAY_SIZE(gcc_sm7150_hws),
...
static int gcc_sm7150_probe(struct platform_device *pdev)
{
	...
	ret = qcom_cc_really_probe(pdev, &gcc_sm7150_desc, regmap);
	if (ret) {
	...
	//ret = qcom_cc_register_rcg_dfs(pdev, &gcc_sm7150_dfs_desc);
	if (ret)
...
MODULE_ALIAS("platform:gcc-sm7150");
