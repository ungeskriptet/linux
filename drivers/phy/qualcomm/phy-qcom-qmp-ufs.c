...
static const struct qmp_phy_init_tbl sm7125_ufsphy_rx[] = {
	QMP_PHY_INIT_CFG(QSERDES_V3_RX_SIGDET_LVL, 0x24),
	QMP_PHY_INIT_CFG(QSERDES_V3_RX_SIGDET_CNTRL, 0x0f),
	QMP_PHY_INIT_CFG(QSERDES_V3_RX_SIGDET_DEGLITCH_CNTRL, 0x1e),
	QMP_PHY_INIT_CFG(QSERDES_V3_RX_RX_INTERFACE_MODE, 0x40),
...
static const struct qmp_phy_init_tbl sm7125_ufsphy_pcs[] = {
...
static const struct qmp_phy_cfg sm7125_ufsphy_cfg = {
	...
	.tbls = {
		...
		.tx_num		= ARRAY_SIZE(sdm845_ufsphy_tx),
		.rx		= sm7125_ufsphy_rx,
		.rx_num		= ARRAY_SIZE(sm7125_ufsphy_rx),
		.pcs		= sm7125_ufsphy_pcs,
		.pcs_num	= ARRAY_SIZE(sm7125_ufsphy_pcs),
	},
	.tbls_hs_b = {
		.serdes		= sdm845_ufsphy_hs_b_serdes,
		.serdes_num	= ARRAY_SIZE(sdm845_ufsphy_hs_b_serdes),
